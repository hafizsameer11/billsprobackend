 ...
 *   /visacard/createcard | fundcard | getcard | getallcards | blockcard | unblockcard (same Pagocards keys + base URL).
...
return [
    ...
    'endpoints' => [
        ...
        'visa_get_card' => env('MASTERCARD_API_VISA_GET_CARD_PATH') ?: '/visacard/getcard',
    ...
    'visa_493' => [
        ...
        /** When true, withdraw Pagocards auto-initial-load so new cards start at $0 (default false — $5 product credit stays on card). */
        'strip_unexpected_initial_load' => filter_var(env('VISA_493_STRIP_UNEXPECTED_INITIAL_LOAD', 'false'), FILTER_VALIDATE_BOOLEAN),
        'endpoints' => [
