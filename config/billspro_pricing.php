...
return [
    ...
    'virtual_card' => [
        ...
        'visa_493_creation' => [
            'label' => 'Visa (493) Card Issuance',
            'fee_usd' => 8,
            'provider_cost_usd' => 3,
        ],
        'visa_493_fund' => [
            'label' => 'Visa (493) Card Funding',
            'fee_usd' => 1,
            'percentage_fee' => 0,
            'provider_cost_usd' => 1,
            'provider_pct' => 2,
        ...
        'visa_493_terminate' => [
            'label' => 'Visa (493) Card Termination Refund',
            'fee_usd' => 1,
            'exchange_rate_ngn_per_usd' => 1420,
        ],
    ],
    ...
    'catalog' => [
        ...
        ['group' => 'Virtual cards', 'slug' => 'virtual_card|visa_493_creation|||'],
        ['group' => 'Virtual cards', 'slug' => 'virtual_card|visa_493_fund|||'],
        ...
        ['group' => 'Virtual cards', 'slug' => 'virtual_card|visa_493_terminate|||'],
