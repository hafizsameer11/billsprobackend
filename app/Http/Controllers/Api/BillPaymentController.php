...
class BillPaymentController extends Controller
{
    ...
    /**
     * @return JsonResponse|null JSON error when legacy simulated flow is disabled
     */
    protected function legacyBillPaymentBlockedResponse(): ?JsonResponse
    {
        if (! PalmPayConfig::usePalmPayForBillPayment()) {
            return null;
        }

        return ResponseHelper::error(
            'Use PalmPay bill APIs for live payments (airtime, data, betting).',
            400,
            [
                'palmpay' => [
                    'billers' => '/api/bill-payment/palmpay/billers',
                    'items' => '/api/bill-payment/palmpay/items',
                    'verify_account' => '/api/bill-payment/palmpay/verify-account',
                    'create_order' => '/api/bill-payment/palmpay/create-order',
                ],
            ]
        );
    }
    ...
    {
        try {
            if ($r = $this->legacyBillPaymentBlockedResponse()) {
                return $r;
            }
